...
class PortfolioGallery {
    constructor() {
        this.portfolioItems = [
            ...
            {
                id: 2,
                title: "خزانة ملابس بإضاءة LED",
                titleEn: "LED Wardrobe with Islamic Design",
                description: "خزانة ملابس عصرية بإضاءة LED متطورة وزخارف إسلامية أنيقة",
                category: "custom",
                image: "wardrobe-led.jpg",
                year: "2024"
            },
            {
                id: 3,
            ...
            },
            {
                ...
                category: "doors",
                image: "shower-cabin-1.jpg",
                year: "2024"
            },
            {
                id: 5,
                title: "كابينة دوش بتصميم عصري",
                titleEn: "Modern Shower Cabin Design",
                description: "تصميم عصري لكابينة دوش بإطار ألمنيوم متين وزجاج شفاف",
                category: "doors",
                image: "shower-cabin-2.jpg",
                year: "2024"
            }
        ];
        ...
        return `
            <div class="portfolio-item fade-in" data-id="${item.id}" data-category="${item.category}">
                ...
                <div class="portfolio-content">
                    ...
                    <a href="https://wa.me/212XXXXXXXXX?text=مرحباً، أريد الاستفسار عن ${item.title}" 
        ...
        modalBody.innerHTML = `
            ...
            <div class="modal-info">
                ...
                <div class="modal-actions">
                    <a href="https://wa.me/212XXXXXXXXX?text=مرحباً، أريد الاستفسار عن ${item.title} في ${item.location}" 
                       class="btn btn-whatsapp" target="_blank">
                        <i class="fab fa-whatsapp"></i> استفسر عن مشروع مماثل
                    </a>
                    <a href="https://wa.me/212XXXXXXXXX?text=أريد طلب عرض سعر لمشروع مماثل لـ ${item.title}" 
